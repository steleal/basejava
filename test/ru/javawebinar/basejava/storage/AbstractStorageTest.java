...
public abstract class AbstractStorageTest {
    ...
    private static final Resume RESUME_1 = new Resume(UUID_1, "C");
    private static final Resume RESUME_2 = new Resume(UUID_2, "B");
    private static final Resume RESUME_3 = new Resume(UUID_3, "A");
    ...
    public void getAllSorted() {
        Resume[] expectedResumes = new Resume[]{RESUME_3, RESUME_2, RESUME_1};
