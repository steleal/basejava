...
public class ResumeTestData {
    ...
    private static Resume createKislinResume() {
        ...
        Map<SectionType, AbstractSection> sections = resume.getSections();
        sections.put(OBJECTIVE, new SimpleLineSection<>("Ведущий стажировок и корпоративного обучения по Java Web и Enterprise технологиям"));

        sections.put(PERSONAL, new SimpleLineSection<>("Аналитический склад ума, сильная логика, креативность, инициативность. " +
        ...
        sections.put(EXPERIENCE, new ListSection<>(Arrays.asList(
                new Position(new Company("Java Online Projects", "http://javaops.ru/"),
                        YearMonth.of(2013, 10),
                        YearMonth.now(),
                        "Автор проекта.",
                        "Создание, организация и проведение Java онлайн проектов и стажировок."),
                new Position(new Company("Wrike", "https://www.wrike.com/"),
                ...
                new Position(new Company("RIT Center", ""),
                        YearMonth.of(2012, 4),
                        YearMonth.of(2014, 10),
                        "Java архитектор",
                ...
                new Position(new Company("Luxoft (Deutsche Bank)", "http://www.luxoft.ru/"),
                ...
                new Position(new Company("Yota", "https://www.yota.ru/"),
                        YearMonth.of(2008, 6),
                        YearMonth.of(2010, 12),
                        "Ведущий специалист",
                ...
                new Position(new Company("Enkata", "http://enkata.com/"),
                        YearMonth.of(2007, 3),
                        YearMonth.of(2008, 6),
                        "Разработчик ПО",
                        "Реализация клиентской (Eclipse RCP) и серверной (JBoss 4.2, Hibernate 3.0, Tomcat, JMS) " +
                                "частей кластерного J2EE приложения (OLAP, Data mining)."),
                new Position(new Company("Siemens AG", "https://www.siemens.com/ru/ru/home.html"),
                        YearMonth.of(2005, 1),
                        YearMonth.of(2007, 2),
                        "Разработчик ПО",
        ...
        sections.put(EDUCATION, new ListSection<>(Arrays.asList(
                new Position(new Company("Coursera", "https://www.coursera.org/course/progfun"),
                        YearMonth.of(2013, 3),
                        YearMonth.of(2013, 5),
                        "\"Functional Programming Principles in Scala\" by Martin Odersky", ""),
                new Position(new Company("Luxoft", "http://www.luxoft-training.ru/training/catalog/course.html?ID=22366"),
                        YearMonth.of(2011, 3),
                        YearMonth.of(2011, 4),
                        "Курс \"Объектно-ориентированный анализ ИС. Концептуальное моделирование на UML.\"", ""),
                new Position(new Company("Siemens AG", "http://www.siemens.ru/"),
                        YearMonth.of(2005, 1),
                        YearMonth.of(2005, 4),
                ...
                new Position(new Company("Заочная физико-техническая школа при МФТИ", "http://www.school.mipt.ru/"),
                        YearMonth.of(1984, 9),
                        YearMonth.of(1987, 6),
                        "Закончил с отличием", "")
        )));
